require([
    ...
    const w3wLocator = esriRequest(
        ...
        const records = `1. ///clean.wider.both<br/>2. ///slam.pilots.castle<br/>3. ///fence.gross.bats<br/>4. ///slips.duke.flown<br/>5. ///native.crew.spoon<br/>6. ///grab.bucket.over<br/>7. ///tennis.rental.globe<br/>8. ///bend.mouse.assume<br/>9. ///trips.sleepy.forgot<br/>10. ///over.poems.shell`;
